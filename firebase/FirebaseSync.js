...
const WORLD_CITIES = [
    ...
    { name: 'New York',     lat: 40.7128,  lon: -74.0060, tz: 'America/New_York',     offset: 300 },
    { name: 'London',       lat: 51.5074,  lon: -0.1278,  tz: 'Europe/London',        offset: 0 },
    { name: 'Paris',        lat: 48.8566,  lon: 2.3522,   tz: 'Europe/Paris',         offset: -60 },
    { name: 'Sydney',       lat: -33.8688, lon: 151.2093, tz: 'Australia/Sydney',     offset: -660 },
    { name: 'Dubai',        lat: 25.2048,  lon: 55.2708,  tz: 'Asia/Dubai',           offset: -240 },
    { name: 'São Paulo',    lat: -23.5505, lon: -46.6333, tz: 'America/Sao_Paulo',    offset: 180 },
    { name: 'Mumbai',       lat: 19.0760,  lon: 72.8777,  tz: 'Asia/Kolkata',         offset: -330 },
    { name: 'Cairo',        lat: 30.0444,  lon: 31.2357,  tz: 'Africa/Cairo',         offset: -120 },
    { name: 'Moscow',       lat: 55.7558,  lon: 37.6173,  tz: 'Europe/Moscow',        offset: -180 },
    { name: 'Los Angeles',  lat: 34.0522,  lon: -118.2437,tz: 'America/Los_Angeles',  offset: 480 },
    { name: 'Singapore',    lat: 1.3521,   lon: 103.8198, tz: 'Asia/Singapore',       offset: -480 },
    { name: 'Berlin',       lat: 52.5200,  lon: 13.4050,  tz: 'Europe/Berlin',        offset: -60 },
    { name: 'Bangkok',      lat: 13.7563,  lon: 100.5018, tz: 'Asia/Bangkok',         offset: -420 },
    { name: 'Reykjavik',    lat: 64.1466,  lon: -21.9426, tz: 'Atlantic/Reykjavik',   offset: 0 },
    { name: 'Honolulu',     lat: 21.3069,  lon: -157.8583,tz: 'Pacific/Honolulu',     offset: 600 },
    { name: 'Anchorage',    lat: 61.2181,  lon: -149.9003,tz: 'America/Anchorage',    offset: 540 },
    { name: 'Helsinki',     lat: 60.1699,  lon: 24.9384,  tz: 'Europe/Helsinki',      offset: -120 },
    { name: 'Buenos Aires', lat: -34.6037, lon: -58.3816, tz: 'America/Argentina/Buenos_Aires', offset: 180 },
    { name: 'Nairobi',      lat: -1.2921,  lon: 36.8219,  tz: 'Africa/Nairobi',       offset: -180 },
];
